...
const AboutUs = () => {
  ...
  const { about_content, name } = details;
    ...
    <Layout title="About Us" description="This is about us page">
      ...
      <div className="bg-white">
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="grid grid-flow-row lg:grid-cols-2 gap-4 lg:gap-10 items-center">
            <div className="">
              <h3 className="text-xl lg:text-3xl mb-1 font-serif font-semibold">
                Welcome to our {name} !
              </h3>
              ...
              <div className="grid md:grid-cols-1 gap-6 lg:grid-cols-1:gap-6 mt-8">
                <div className="p-8 bg-indigo-50 shadow-sm rounded-lg">
                  <span className="text-3xl block font-extrabold font-serif mb-4 text-gray-800 text-center">
                    10K
                  </span>
                  <h4 className="text-lg font-serif font-bold mb-1 text-center">
                    Listed Products
                  </h4>
                  <p className="mb-0 opacity-90 leading-7 text-center">
                    Dynamically morph team driven partnerships after vertical.{" "}
                  </p>
                </div>
                <div className="p-8 bg-indigo-50 shadow-sm rounded-lg text-center">
          ...
          <div className="mt-10 lg:mt-16 text-base opacity-90 leading-7">
            ...
            <p dangerouslySetInnerHTML={{ __html: about_content }}></p>
          </div>
