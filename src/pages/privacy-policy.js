        ...
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-4 sm:px-10">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p dangerouslySetInnerHTML={{ __html: privacy_policy }}></p>
              {/* <p>
                At , accessible from kachabazar dot com, one of our
        ...
        <div className="mb-8 lg:mb-12 last:mb-0">
          ...
          <div className="font-sans leading-7">
            <p>
              ...
              the advertising partners of Your E-Store. Third-party ad servers
              ...
              that appear on Your E-Store, which are sent directly to users'
              ...
              that Your E-Store has no access to or control over these cookies
