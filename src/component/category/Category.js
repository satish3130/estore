...
import { Featuredcategoryapi, Products } from "../../services/storeapi";
import { SetPopularcategory } from "../../storage/redux/actions/detailActions";
          ...
          {categories &&
            categories?.map((category) => (
              <CategoryCard
                key={category._id}
                title={category.name}
                icon={category.file == null ? "/assets.png" : category.file}
                nested={category.id}
              />
            ))}
        </div>
